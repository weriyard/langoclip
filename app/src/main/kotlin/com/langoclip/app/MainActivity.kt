...
import com.langoclip.app.data.Tab as DataTab
import com.langoclip.app.ui.ChatTabContent
import com.langoclip.app.ui.ExamplesTabContent
...
import com.langoclip.app.ui.TabsViewModel
import com.langoclip.app.ui.WordTranslationTabContent
import com.langoclip.app.ui.theme.AppTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun writeClipboard(text: String) {
        val cm = getSystemService(Context.CLIPBOARD_SERVICE) as ClipboardManager
        cm.setPrimaryClip(ClipData.newPlainText("LangoClip", text))
    }
