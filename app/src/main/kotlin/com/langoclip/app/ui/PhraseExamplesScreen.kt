...
private fun exampleSourceChips(sense: WordSense): List<String> {
    val en = when (sense.exampleSource) {
        com.langoclip.app.actions.ExampleSource.API -> "DA"
        com.langoclip.app.actions.ExampleSource.KAIKKI -> "KA"
        com.langoclip.app.actions.ExampleSource.GENERATED -> "GN"
        com.langoclip.app.actions.ExampleSource.NONE -> "—"
    }
